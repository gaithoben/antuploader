...
function (_Component) {
  ...
  function Upload(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "recentUploadStatus", void 0);

    _defineProperty(_assertThisInitialized(_this), "progressTimer", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "onSuccess", function (response, file) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleManualRemove", function (file) {
      if (_this.upload) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderUploadList", function (locale) {
      ...
      return _react.default.createElement(_UploadList.default, {
        ...
        locale: _objectSpread({}, locale, _this.props.locale)
      });
    });

    _defineProperty(_assertThisInitialized(_this), "renderUpload", function (_ref2) {
      var _classNames2;
      ...
      var rcUploadProps = _objectSpread({
      ...
      if (type === 'drag') {
        ...
        }, _react.default.createElement(_rcUpload.default, _extends({}, rcUploadProps, {
  ...
  _createClass(Upload, [{
    ...
    value: function render() {
      return _react.default.createElement(_configProvider.ConfigConsumer, null, this.renderUpload);
    }
  }]);
